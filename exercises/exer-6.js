...
function Tarea6(EmpresasLoads) {
  let AllWorkersNews = {};

  EmpresasLoads.forEach((RowEmpresa) => {
    RowEmpresa.users.forEach((RowWorkers) => {
      let Username =
        RowWorkers.lastName + RowWorkers.firstName + RowWorkers.age;
      AllWorkersNews[Username] = RowWorkers.car;
    });
  });

  return AllWorkersNews;
}

//ejecutar
console.log(Tarea6(companies));
